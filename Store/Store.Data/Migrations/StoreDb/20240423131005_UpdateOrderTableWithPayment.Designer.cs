...
namespace Store.Data.Migrations.StoreDb
{
    ...
    [Migration("20240423131005_UpdateOrderTableWithPayment")]
    partial class UpdateOrderTableWithPayment
    {
            ...
            modelBuilder.Entity("Store.Data.Entities.OrderEntities.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Store.Data.Entities.OrderEntities.ProductItemOrder", "ItemOrder", b1 =>
                        {
